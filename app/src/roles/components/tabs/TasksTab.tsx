  ...
  return (
    <TabPanel id="tasks">
      <div className="border rounded border-neutral-700 p-4">
        ...
        <div className="py-2 flex justify-between items-center gap-2 mt-2">
          <div>
            <h4 className="font-bold">Vergangen</h4>
            <p className="text-sm text-neutral-400">
              Citizen mit dieser Berechtigung können alle abgeschlossenen,
              abgelaufenen oder abgebrochenen Tasks einsehen.
            </p>
          </div>

          <YesNoCheckbox {...register("task;read;taskState=past")} />
        </div>
        ...
        <div className="py-2 flex justify-between items-center gap-2 mt-2">
          ...
          <YesNoCheckbox {...register("task;read;taskState=deleted")} />
        </div>
      </div>
      ...
      <div className="border rounded border-neutral-700 p-4 mt-4">
        ...
        <div className="py-2 flex justify-between items-center gap-2 mt-2">
          <div>
            ...
            <p className="text-sm text-neutral-400">
              ...
              erstellen, welcher von allen eingesehen und geclaimt werden kann.
            </p>
          </div>

          <YesNoCheckbox
            {...register(
              "task;create;taskVisibility=public;taskRewardType=other",
            )}
          />
        </div>
        ...
        <div className="py-2 flex justify-between items-center gap-2 mt-2">
          ...
          <YesNoCheckbox
            {...register(
              "task;create;taskVisibility=public;taskRewardType=silc",
            )}
          />
        </div>
        ...
        <div className="py-2 flex justify-between items-center gap-2 mt-2">
          ...
          <YesNoCheckbox
            {...register(
              "task;create;taskVisibility=personalized;taskRewardType=other",
            )}
          />
        </div>
        ...
        <div className="py-2 flex justify-between items-center gap-2 mt-2">
          ...
          <YesNoCheckbox
            {...register(
              "task;create;taskVisibility=personalized;taskRewardType=silc",
            )}
          />
        </div>
      </div>
