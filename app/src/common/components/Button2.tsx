  ...
  return (
    <Component
      className={clsx(
        ...
        {
          "bg-interaction-500 text-neutral-50 enabled:hover:bg-interaction-300 [&[href]]:hover:bg-interaction-300 enabled:focus-visible:outline [&[href]]:focus-visible:outline outline-2 outline-offset-4 outline-interaction-700 enabled:active:bg-interaction-700 [&[href]]:active:bg-interaction-700 transition-colors":
            variant === "primary" && colorSchema === "interaction",
          "bg-transparent text-interaction-500 border border-interaction-500 border-solid enabled:hover:text-interaction-300 [&[href]]:hover:text-interaction-300 enabled:hover:border-interaction-300 [&[href]]:hover:border-interaction-300 enabled:focus-visible:outline [&[href]]:focus-visible:outline outline-2 outline-offset-4 outline-interaction-700 enabled:active:text-interaction-700 [&[href]]:active:text-interaction-700 enabled:active:border-interaction-700 [&[href]]:active:border-interaction-700 transition-colors":
