  ...
  return (
    <main className="p-2 lg:p-8 pt-20">
      ...
      {countedOrgShips.length > 0 ? (
        <div className="rounded-2xl bg-neutral-800/50 backdrop-blur p-4 lg:p-8 mt-4 overflow-auto">
          <FleetTable ships={countedOrgShips} />
        </div>
      ) : (
        <div className="bg-neutral-800/50 backdrop-blur rounded-2xl p-4 lg:p-8 max-w-4xl mt-4">
